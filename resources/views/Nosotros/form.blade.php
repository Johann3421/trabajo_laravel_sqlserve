...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('description', $nosotros->description, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('stock', $nosotros->stock, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('price', $nosotros->price, ['class' => 'form-control' .
    ...
    <div class="form-footer">
        <div class="text-end">
            <div class="d-flex">
                ...
                <button type="submit" class="btn btn-primary ms-auto ajax-submit">Confirmar venta</button>
            </div>
        </div>
    </div>
